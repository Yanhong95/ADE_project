...
public class AdminCreateScreen extends javax.swing.JPanel {
 ...
 //       initialize();
    ...
    private  boolean usernamePattern(){
        Pattern p = Pattern.compile("^[A-Za-z0-9][A-Za-z0-9_]+@[0-9A-Za-z_]+\\.[0-9A-Za-z_]+");
    ...
    private void initComponents() {
        ...
        userButtonGroup.add(radioCustomer);
        ...
        userButtonGroup.add(radioSupplier);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(txtUser.getText().isEmpty()||txtPword.getText().isEmpty()||txtRePword.getText().isEmpty()){
            JOptionPane.showMessageDialog(panelRight, "Empty content, Please recreate!");
            return;
        }
        if(!usernamePattern()){
            JOptionPane.showMessageDialog(panelRight, "username should be an Email ID form ");
            return;
        }
        if(!passwordPattern()){
            JOptionPane.showMessageDialog(panelRight, "password must contain alphanumeric with '+_$'! ");
            return;
        }
        if(!txtPword.getText().equals(txtRePword.getText())){
            txtRePword.setText("");
            txtRePword.setBackground(Color.red);
            JOptionPane.showMessageDialog(panelRight, "password dont match! ");
            return;
        }
        if (userButtonGroup.isSelected(radioCustomer.getModel())){
            ...
            JOptionPane.showMessageDialog(panelRight, "Customer successfully created! ");
            txtRePword.setText("");
            txtPword.setText("");
            txtUser.setText("");
        }else if(userButtonGroup.isSelected(radioSupplier.getModel())){
            txtRePword.setBackground(Color.white);
            Supplier supplier= new Supplier(txtPword.getText(),txtUser.getText());
            admin.getSuppDir().getSupplierList().add(supplier);
            JOptionPane.showMessageDialog(panelRight, "Supplier successfully created! ");
            txtRePword.setText("");
            txtPword.setText("");
            txtUser.setText("");
        }

...
public class LoginScreen extends javax.swing.JPanel {
    ...
    JPanel panelRight;
    int num;
    public LoginScreen(JPanel panelRight, List<User> list, int n) {
        initComponents();
        this.list = list;
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
       ...
       if(num == 1){
       Supplier sup = (Supplier) comboUser.getSelectedItem();
       String password = sup.getPassword();
       if(!pword.equals(password)){
       JOptionPane.showMessageDialog(null, "The Password is Wrong!", "Alert", JOptionPane.ERROR_MESSAGE);
       txtPword.setText("");
       return;
       }
       SuccessScreen panel = new SuccessScreen(list,sup,panelRight,num);
       panelRight.removeAll();
       panelRight.add("SuccessScreen", panel);
       CardLayout cl= (CardLayout) panelRight.getLayout();
       cl.next(panelRight);
       }else{
       Customer cus=(Customer) comboUser.getSelectedItem();
       ...
       SuccessScreen panel = new SuccessScreen(list,cus,panelRight,num);
       panelRight.removeAll();
       panelRight.add("SuccessScreen",panel);
       CardLayout cl = (CardLayout) panelRight.getLayout();
       cl.next(panelRight);

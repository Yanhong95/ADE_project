...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    public CreateProductJPanel(JPanel rightJPanel,ProductDirectory prodDir) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(txtPrice.getText().isEmpty() || txtProdName.getText().isEmpty() || this.txtAvailablity.getText().isEmpty()){

...
public class AddSecondhandItemPanel extends javax.swing.JPanel {
    ...
    public AddSecondhandItemPanel(EcoSystem system, BookStoreEnterprise bookStoreEnterprise,Employee employee,  JPanel rightPanel) {
        initComponents();
        this.system = system;
    ...
    public int getItemID(){
        ...
        if(bookStoreEnterprise.getOldBookDirectory().getItemList().isEmpty()){
           return originItemID;
        }else{
        for(Item itemList : bookStoreEnterprise.getOldBookDirectory().getItemList()) {
    ...
    public  ArrayList<String> checkImageName(){
        ...
        File file = new File("SecondhandItemPictures");
   ...
   public void deleteImage(String imagePath){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Secondhand Item");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, 200, 45));
        ...
        add(returnBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 370, 180, -1));

        addItemBtn.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        addItemBtn.setText("Add Secondhand Item");
        addItemBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addItemBtnActionPerformed(evt);
            }
        });
        add(addItemBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, 180, -1));
        ...
        add(addImagePathBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 180, 30));
    ...
    private void addItemBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addItemBtnActionPerformed
        ...
        if(bookName.equals(item.getBook().getTitle())){
            JOptionPane.showMessageDialog(null, "This secondhand already exists, Please return to previous page and select button of upadte "); 
            return;
            }
        }
        ...
        if(bookAuthorList.contains(bookAuthor)&&bookNameList.contains(bookName)){
            for(Book b:system.getBookDirectory().getBookList()){ 
                ...
                bookStoreEnterprise.getOldBookDirectory().getItemList().add(item);
                JOptionPane.showMessageDialog(null, "Secondhand Item added Successfully");
    ...
    private void addImagePathBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addImagePathBtnActionPerformed
        ...
        if(i == chooser.APPROVE_OPTION){
            ...
            String finalImagePath = "SecondhandItemPictures/" + imageName;

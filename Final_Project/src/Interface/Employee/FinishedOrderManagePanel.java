 ...
 * @author chenchen
 */
public class FinishedOrderManagePanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form FinishedOrderManagePanel
     */
    public FinishedOrderManagePanel(EcoSystem system, Employee employee, javax.swing.JPanel rightPanel) {
        initComponents();
        this.system = system;
    ...
    public void showInfo(){
        ...
        dtm.setRowCount(0);
        if(organization.getOrderList().size()>0){
            for(Order or : organization.getOrderList()){
